...
ROOT_DIR1 = os.path.abspath("/content")
MODEL_DIR = os.path.join(ROOT_DIR1, "drive/MyDrive/seg_images_save")
...
def test_random_image(test_model, src_folder):
    ...
    for file in files:
      ...
      if len(mask != 0):
          ...
          save_path = os.path.join(MODEL_DIR,"segment_output/"+file_name)
